...
const DEFAULT_WORDS = ["ORVEL", "PARFUME", "LUXURY", "SCENT", "EMOTION"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    offscreenCtx.font = "110px BebasNeue, sans-serif"
    ...
    // Green-tinted colors for Orvel brand
    const greenPalette = [
    ...
    const newColor = greenPalette[Math.floor(Math.random() * greenPalette.length)]
